...
Truth split:
- `/home/greg/src/tmux` is the behavioral oracle.
- `ralphq` is the only live work queue.
...
- `/goodz/work/agents/zmux/TODO.md` is for elegance debt only.
- `/goodz/work/agents/zmux/utf8-midgame-brainstorm.md` is background only.
