...
- row 7's raw prompt-storage blocker is gone, shared cursor/history/completion
  ...
  alerts/cmdq/display-message/list-keys set, actual scrollbar drawing, the
  outer tty mouse-mode runtime, and fuller overlay/runtime semantics are still
  missing
